CXX=g++
COMMONFLAGS=-std=c++14 -I./src/cutf -I./src/wmma-extension/include -I./src/runtime-status -DRS_GIT_BRANCH="\"$(shell git branch | grep '\*' | sed -e 's/.* //')\"" -DRS_GIT_COMMIT="\"$(shell git rev-parse HEAD)\""
