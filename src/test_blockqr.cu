...
void mtk::test_blockqr::precision(const std::size_t min_m, const std::size_t max_m) {
...
template void mtk::test_blockqr::precision<true, false, float, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<true, false, half, half>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<false, false, float, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<false, false, half, half>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<true, true, float, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<true, false, float, half>(const std::size_t, const std::size_t);

template <bool UseTC, bool Refine, class T, class CORE_T>
void mtk::test_blockqr::speed(const std::size_t min_m, const std::size_t max_m) {
	constexpr std::size_t C = 16;
	std::mt19937 mt(std::random_device{}());
	std::uniform_real_distribution<> dist(-1.0f, 1.0f);
...
template void mtk::test_blockqr::speed<true, false, float, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::speed<true, false, half, half>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::speed<false, false, float, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::speed<false, false, half, half>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::speed<true, true, float, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::speed<true, false, float, half>(const std::size_t, const std::size_t);

template <class T>
void mtk::test_blockqr::cusolver_precision(const std::size_t min_m, const std::size_t max_m) {
...
template void mtk::test_blockqr::cusolver_precision<float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::cusolver_precision<double>(const std::size_t, const std::size_t);

template <class T>
void mtk::test_blockqr::cusolver_speed(const std::size_t min_m, const std::size_t max_m) {
	constexpr std::size_t block_size = 256;
	constexpr std::size_t C = 16;
	std::mt19937 mt(std::random_device{}());
	std::uniform_real_distribution<> dist(-1.0f, 1.0f);
...
template void mtk::test_blockqr::cusolver_speed<float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::cusolver_speed<double>(const std::size_t, const std::size_t);
