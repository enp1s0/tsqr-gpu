...
template void mtk::test_blockqr::precision<true, false, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<true, false, half>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<false, false, float>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<false, false, half>(const std::size_t, const std::size_t);
template void mtk::test_blockqr::precision<true, true, float>(const std::size_t, const std::size_t);
