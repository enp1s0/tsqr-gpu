...
template void mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_nocor    , false>(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
template void mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_cor      , false>(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
...
template void mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_nocor    , true >(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
template void mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_cor      , true >(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
...
template void mtk::test_qr::speed<mtk::test_qr::compute_mode::tf32_tc_nocor    , false>(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
template void mtk::test_qr::speed<mtk::test_qr::compute_mode::tf32_tc_cor      , false>(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
...
template void mtk::test_qr::speed<mtk::test_qr::compute_mode::tf32_tc_nocor    , true >(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
template void mtk::test_qr::speed<mtk::test_qr::compute_mode::tf32_tc_cor      , true >(const std::vector<std::tuple<std::size_t, std::size_t, float>>&, const std::size_t);
