...
template <class T>
void check_orthogonality16_each(double &diag, double &non_diag, const T* const matrix, const std::size_t m, const unsigned n);
template <class T>
...
template <class T>
void exponent_distribution(const T* const ptr, const std::size_t size, const char* const compute_mode_str, const char* const csv_item_name, cudaStream_t stream = 0);
} // namespace validation
} // namespace mtk
