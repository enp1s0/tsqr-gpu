...
template mtk::qr::state_t mtk::qr::qr<true , false, false, float, half >(float* const, const std::size_t, float* const, const std::size_t, float* const, const std::size_t, const std::size_t, const std::size_t, typename mtk::qr::get_working_q_type<float, true , false>::type* const, typename mtk::qr::get_working_r_type<float, true , false>::type* const, unsigned* const, unsigned* const, cublasHandle_t const);
