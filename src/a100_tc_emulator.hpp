...
__device__ inline void gemm_core16x16(T* const c, const unsigned ldm_c, const T* const a, const unsigned ldm_a, const T* const b, const unsigned ldm_b, const unsigned unique_id) {
	mtk::gemm_core16x16<T, 1>(c, ldm_c, a, ldm_a, b, ldm_b, unique_id);
}

template <> __device__ inline void gemm_core16x16<mtk::matmul::compute_mode::tf32_tc_cor_emu, float>(float* const c, const unsigned ldm_c, const float* const a, const unsigned ldm_a, const float* const b, const unsigned ldm_b, const unsigned unique_id) {
...
template <> __device__ inline void gemm_core16x16<mtk::matmul::compute_mode::mixed_tc_cor, float>(float* const c, const unsigned ldm_c, const float* const a, const unsigned ldm_a, const float* const b, const unsigned ldm_b, const unsigned unique_id) {
	constexpr unsigned warp_size = 32;
	const auto lane = unique_id >> 4;
	const auto y = unique_id & 0xf;
	float tmp_a[16];
...
template <> __device__ inline void gemm_core16x16<mtk::matmul::compute_mode::tf32_tc_nocor_emu, float>(float* const c, const unsigned ldm_c, const float* const a, const unsigned ldm_a, const float* const b, const unsigned ldm_b, const unsigned unique_id) {
	constexpr unsigned warp_size = 32;
	const auto lane = unique_id >> 4;
	const auto y = unique_id & 0xf;
	float tmp_a[16];
...
__device__ inline void matmul_core16x16(T* const c, const unsigned ldm_c, const T* const a, const unsigned ldm_a, const T* const b, const unsigned ldm_b, const unsigned unique_id) {
	mtk::matmul_core16x16<T, 1>(c, ldm_c, a, ldm_a, b, ldm_b, unique_id);
}
