...
void qr_test(const std::vector<std::tuple<std::size_t, std::size_t, float>>& test_matrix_config_list) {
	...
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp16_notc    , false>(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp16_tc_nocor, false>(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp32_notc    , false>(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp32_tc_nocor, false>(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp32_tc_cor  , false>(test_matrix_config_list);

	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp16_notc    , true >(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp16_tc_nocor, true >(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp32_notc    , true >(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp32_tc_nocor, true >(test_matrix_config_list);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::fp32_tc_cor  , true >(test_matrix_config_list);

	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp16_notc    , false>(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp16_tc_nocor, false>(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp32_notc    , false>(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp32_tc_nocor, false>(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp32_tc_cor  , false>(test_matrix_config_list);

	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp16_notc    , true >(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp16_tc_nocor, true >(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp32_notc    , true >(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp32_tc_nocor, true >(test_matrix_config_list);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::fp32_tc_cor  , true >(test_matrix_config_list);
