...
#ifdef TF32_ENABLED
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_nocor    , false>(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_cor      , false>(test_matrix_config_list, test_count);
#endif
...
#ifdef TF32_ENABLED
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_nocor    , true >(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy<mtk::test_qr::compute_mode::tf32_tc_cor      , true >(test_matrix_config_list, test_count);
#endif
...
#ifdef TF32_ENABLED
	mtk::test_qr::speed<mtk::test_qr::compute_mode::tf32_tc_cor  , false>(test_matrix_config_list, test_count);
	mtk::test_qr::speed<mtk::test_qr::compute_mode::tf32_tc_cor  , false>(test_matrix_config_list, test_count);
#endif
...
void qr_test_cond(const std::vector<std::tuple<std::size_t, std::size_t, float>>& test_matrix_config_list) {
	...
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp16_notc        , false>(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp16_tc_nocor    , false>(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp32_notc        , false>(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp32_tc_nocor    , false>(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp32_tc_cor      , false>(test_matrix_config_list, test_count);
#ifdef TF32_ENABLED
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::tf32_tc_nocor    , false>(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::tf32_tc_cor      , false>(test_matrix_config_list, test_count);
#endif

	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp16_notc        , true >(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp16_tc_nocor    , true >(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp32_notc        , true >(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp32_tc_nocor    , true >(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::fp32_tc_cor      , true >(test_matrix_config_list, test_count);
#ifdef TF32_ENABLED
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::tf32_tc_nocor    , true >(test_matrix_config_list, test_count);
	mtk::test_qr::accuracy_cond<mtk::test_qr::compute_mode::tf32_tc_cor      , true >(test_matrix_config_list, test_count);
#endif
