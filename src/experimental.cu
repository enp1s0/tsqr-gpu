...
template <class T>
void mtk::experimental::force_exponent(T* const ptr, const int min_exponent, const std::size_t size, cudaStream_t cuda_stream) {
...
template <> void mtk::experimental::force_exponent<half >(half * const, const int, const std::size_t, cudaStream_t);
template <> void mtk::experimental::force_exponent<float>(float* const, const int, const std::size_t, cudaStream_t);
